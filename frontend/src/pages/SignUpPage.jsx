...
import { Eye, EyeOff, Loader2, Lock, Mail, BookOpen, User } from 'lucide-react';
        ...
        <div className='w-full max-w-md space-y-2'>
          ...
          <div className='text-center mb-8'>
            <div className='flex flex-col items-center gap-2 group'>
              <h1 className='text-5xl font-bold mt-8 text-base-100'>Create Account</h1>
              <p className='text-2xl text-base-100/90'>Get Started with your free Account</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmition} className=''>
            <div className='form-control'>
              <label className='label'>
                <span className='label-text font-medium text-base-100'>Full Name</span>
              </label>
              <div className='relative'>
                <div className='absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none'>
                  <User className='size-5 text-base-100/60 z-10'/>
                </div>
                <input
                  type='text'
            ...
            <button type='submit' className='btn w-full rounded-full bg-base-100 text-primary hover:bg-base-100/90 border-none font-semibold py-2 transition-all duration-300 transform hover:scale-105 mt-6' disabled={isSignUp}>
              {isSignUp ? (
                <>
          ...
          <div className='text-center'>
            <p className='text-base-100/90'>
              ...
              <Link to="/login" className='text-base-100 font-semibold hover:text-base-100/80 transition-colors underline'>
                Sign In 
              </Link>
            </p>
          </div>
